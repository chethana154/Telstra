System.register(['@angular/core'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            CompanyDetailsComponent = (function () {
                function CompanyDetailsComponent() {
                }
                CompanyDetailsComponent = __decorate([
                    core_1.Component({
                        templateUrl: 'app/Routing_pages/Companies&Technologies/companies/companydetails/company-details.html',
            ...
            exports_1("CompanyDetailsComponent", CompanyDetailsComponent);
        }
    }
});
